...
import com.itmayiedu.itmayiedushopppay.common.JsonResult;
...
public class UnipayController {
     ...
     * @param response
     */
    @RequestMapping(value = "/queryIsSuccess", method = RequestMethod.GET)
    public void queryIsSuccess(HttpServletRequest request, HttpServletResponse response) throws IOException {

        service.queryIsSuccess(request, response,"123456789","2018121111305");
