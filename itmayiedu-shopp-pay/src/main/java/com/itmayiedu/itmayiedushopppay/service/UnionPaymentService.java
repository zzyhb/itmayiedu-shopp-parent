package com.itmayiedu.itmayiedushopppay.service;
...
public interface UnionPaymentService {
    ...
    void queryIsSuccess(HttpServletRequest request, HttpServletResponse response, String s, String s1) throws IOException;
}